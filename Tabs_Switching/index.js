...
function contentShow(filter) {
    var filteredContent = contents.find(function(item) {
        return item.category === filter;
    });

    if (filteredContent) {
        tabTitle.innerText = filteredContent.category;
        contentDisplay.innerText = filteredContent.text;
    }
}